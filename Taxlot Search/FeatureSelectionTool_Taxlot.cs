...
{
    internal class FeatureSelectionTool_Taxlot : MapTool
    {
        public FeatureSelectionTool_Taxlot()
        {
            IsSketchTool = true;
        ...
        protected override async Task<bool> OnSketchCompleteAsync(Geometry geometry)
        {
            ...
            return await QueuedTask.Run(() =>
            {
                ...
                if (LabelLayer != null)
                {
                    ...
                    MessageBox.Show("Warning! Tool canceled because the Taxlot layer was not found on this map");
