...
{
    internal class FeatureSelectionTool_Zoning : MapTool
    {
        public FeatureSelectionTool_Zoning()
        {
            IsSketchTool = true;
        ...
        protected override async Task<bool> OnSketchCompleteAsync(Geometry geometry)
        {
            ...
            return await QueuedTask.Run(() =>
            {
                ...
                if (LabelLayer != null)
                {
                    ...
                    MessageBox.Show("Warning! Tool canceled because the Zoning layer was not found on this map");
